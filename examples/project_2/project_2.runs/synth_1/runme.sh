...
HD_PWD='/home/alex/GitHub/zycap2/zycap/interfacer/examples/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pr_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pr_wrapper.tcl
